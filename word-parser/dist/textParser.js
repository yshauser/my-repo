...
async function writeSequencesToPDF(sequences, outputFileName) {
    ...
    const fontBytes = fs_1.default.readFileSync('./fonts/David.ttf');
    ...
    fs_1.default.writeFileSync(uniqueFileName, pdfBytes);
